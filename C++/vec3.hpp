...
inline vec3 random_in_unit_sphere(){
    ...
    do {
        p_random_in_unit_sphere = 2.0*vec3(((double) rand() / (RAND_MAX)),((double) rand() / (RAND_MAX)),((double) rand() / (RAND_MAX))) - vec3(1.0);
...
inline vec3 random_in_unit_disk(){
    static vec3 p_random_in_unit_sphere;
    do {
        p_random_in_unit_sphere = 2.0*vec3(((double) rand() / (RAND_MAX)),((double) rand() / (RAND_MAX)),0) - vec3(1.0,1.0,0.0);
    }while(p_random_in_unit_sphere.squared_length() >= 1.0);
    return unit_vector(p_random_in_unit_sphere);
}
